...
<head>
    ...
    <title>Registro - Taller Pro</title>
    ...
    <style>
        ...
        /* Fondo específico para Auth (Login/Register) */
        .auth-bg {
                    ...
                    <div class="card card-auth p-4">
                        <div class="card-body">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted small">Únete para gestionar tu moto en tiempo real</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0 ps-0 @error('nombre') is-invalid @enderror"
                                               id="nombre" name="nombre" value="{{ old('nombre') }}" required autofocus autocomplete="nombre" placeholder="Tu nombre">
                                    </div>
                                    @error('nombre')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror"
                                               id="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="ejemplo@correo.com">
                                    </div>
                                    @error('email')
                                        <div class="invalid-feedback d-block small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="d-grid mb-3">
                                    <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow-sm">
                                        Registrarse <i class="bi bi-arrow-right-short"></i>
                                    </button>
                                </div>

                                <div class="text-center mt-3">
                                    <p class="small text-muted mb-0">¿Ya tienes cuenta?</p>
                                    <a href="{{ route('login') }}" class="text-electric fw-bold text-decoration-none">
                                        Inicia sesión aquí
                                    </a>
                                </div>
                            </form>
