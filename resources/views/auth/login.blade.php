...
<head>
    ...
    <style>
        ...
        /* Enlace sutil para "olvidaste contraseña" */
        .link-subtle {
            color: #6c757d;
            font-size: 0.9rem;
                    ...
                    <div class="card card-auth p-4">
                        <div class="card-body">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted small">Accede al panel de control de tu vehículo</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror"
                                               id="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="ejemplo@correo.com">
                                    </div>
                                    @error('email')
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <a href="{{ route('register') }}" class="text-electric fw-bold text-decoration-none">
                                        Regístrate gratis
                                    </a>
                                </div>
                            </form>
