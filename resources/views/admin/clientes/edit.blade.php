...
<div class="welcome-banner">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h5 class="fw-bold mb-1"><i class="fas fa-user-edit me-2" style="color:#FF6600;"></i>Editar Cliente</h5>
            <p class="mb-0" style="opacity:0.75; font-size:0.9rem;">Modifica los datos de <strong>{{ $cliente->nombre }}</strong></p>
        </div>
