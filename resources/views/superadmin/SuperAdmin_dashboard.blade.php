...
@section('page_title', 'Panel Superadmin')
...
<div class="welcome-banner">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4><i class="fas fa-shield-alt me-2" style="color: #FF6600;"></i>Panel de Control — Superadmin</h4>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card azul p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="stat-icon" style="color: #007FFF;">
...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <a href="{{ route('superadmin.usuarios') }}" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="{{ route('superadmin.vehiculos') }}" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="{{ route('superadmin.ordenes') }}" class="text-decoration-none">
            <div class="card stat-card p-3 text-center">
                <div style="color: #FF6600; font-size: 2rem; margin-bottom: 8px;">
